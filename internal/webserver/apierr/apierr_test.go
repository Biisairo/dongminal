...
func TestNoDuplicateCodeValue(t *testing.T) {
	...
	add("CodeRepoBusy", CodeRepoBusy)
	add("CodeIndexLocked", CodeIndexLocked)
	add("CodeServerShutdown", CodeServerShutdown)
	add("CodeStashMoved", CodeStashMoved)
	add("CodeResolvePartial", CodeResolvePartial)
