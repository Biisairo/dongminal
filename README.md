...
> "누구" 는 묻지 않습니다. 이것은 준비 중인 기능이 아니라 **확정된 경계**입니다 —
> 접근 통제를 **망(Tailscale 같은 오버레이 망)과 출발지 허용 목록**에 맡깁니다.
> 그러므로 셋을 지켜 주세요.
>
...
>
> 허용 목록을 통과한 기기는 **전부 동등합니다.** 그중 하나가 허용 목록 자체를
> 끌 수 있습니다. 목록에 넣는 기기는 여러분이 신뢰하는 것이어야 합니다.
>
> 브라우저를 통한 공격(다른 웹페이지가 여러분의 터미널에 명령을 보내는 것)은
> 막혀 있습니다. 위 셋은 **네트워크에서 직접 오는 접속**에 대한 것입니다.
