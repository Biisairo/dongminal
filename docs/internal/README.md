...
| [GIT_SRS.md](./GIT_SRS.md) | **Git 창의 단일 진실 공급원** (IEEE 29148). FR-GIT-1~178, 검증 V1~V69, 21단계 구현 계획. §7 은 확정 결정 O1~O14, §7.1 은 요구사항 해석 I1~I8. **1~20단계 구현 완료, 21단계(수동 검증) 남음** |
...
| 요구 4 — Git 창 (`GIT_SRS`) | **코드 완료** (1~20단계). FR-GIT-1~178 구현, `go test ./... -race` 통과, Playwright 187 → 349. 남은 것은 **21단계 수동 검증**뿐이며 절차는 [GIT_MANUAL_CHECKLIST.md](./GIT_MANUAL_CHECKLIST.md) 다 |
