...
func TestRender_OmitUUIDShort(t *testing.T) {
	l := Line{Label: "W1.P1.T1", PaneID: "12", ShellPID: 1, SizeCols: 80, SizeRows: 24, Session: "x", Tab: "y"}
	got := l.Render()
...
func TestRender_OmitSessionRegionUUID(t *testing.T) {
	l := Line{Label: "W1.P1.T1", UUID: "u", Short: "s", PaneID: "1", ShellPID: 2, SizeCols: 1, SizeRows: 2, Session: "a", Tab: "b"}
	got := l.Render()
