...
| 요구 4 — Git 창 (`GIT_SRS`) | **1~20단계 구현 완료.** `go test ./... -race` 통과, Playwright 187 → 348. **남은 것은 미구현 P0 2건(FR-GIT-141·144)과 21단계 수동 검증**이며 전부 [GIT_REMAINING.md](./GIT_REMAINING.md) 에 있다 |
