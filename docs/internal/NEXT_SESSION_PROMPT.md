...
**M1·M2·M4 완료. Go 측(M1~M5 전 서버 API) 완료.** 남은 것은 M3 클라 · M5 클라 · 20 · 21 뿐이고 전부 프론트엔드다. 기준선 — `go test ./... -race` 전부 통과 ·
gofmt clean · Playwright **187 → 308**.
...
| **M5** | | | |
| 18·19 | Branches · Stash — 서버 완료, **클라 진행** | 진행 | `c9f8134` |
