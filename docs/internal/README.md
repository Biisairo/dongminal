...
| [WORKSPACE_IDENTITY_SRS.md](./WORKSPACE_IDENTITY_SRS.md) | 엔터티 식별자를 클라이언트별 카운터에서 uuid 로, 생성 명령을 단일 실행자로 (IEEE 29148). 다중 클라이언트에서 같은 id·고아 PTY·echo 불일치가 재현됐다. **구현 완료** (`0ec8e02`) |
