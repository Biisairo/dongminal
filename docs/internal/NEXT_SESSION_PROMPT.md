...
**현재: M1 거의 완료 + M2·M4 일부 선행.**
기준선 — `go test ./... -race` 전부 통과(`a2c3abe` 에서 복구) · gofmt clean ·
Playwright **187 → 238**.

| 단계 | 내용 | 상태 | 커밋 |
|:--:|---|---|---|
| — | 21단계 설계 계약 `./design/` + 색인 | ✅ | `67bc325` `ddb4307` |
...
| 3 | 묶음 D Git 창 골격 (e2e 196) | ✅ | `8ed0396` |
| 4 | 묶음 B 클라 좌측 GIT 섹션 (e2e 205) | ✅ | `72bbe00` |
| 5·6 | 묶음 E Changes 읽기 + 묶음 C 클라 폴링 (e2e 228) | ✅ | `747db3a` |
| 7 | 묶음 F diff-content + Monaco DiffEditor (e2e 238) | ✅ | `a9f244e` `f078fdf` |
| 8 | 묶음 G 상태바 chip — **진행** | 진행 | |
| 9 | 묶음 J 안전 정책 — Go 완료, **클라(`GitConfirm`) 진행** | 진행 | `71ed098` |
| 10·11 | 묶음 H 스테이징 · I 커밋 — **서버측 완료**, 클라 남음 | 부분 | `54d869c` |
| 12·13 | M3 원격 (job 인프라 + fetch/pull/push) — **서버측 진행** | 진행 | |
| 14 | M4 로그·커밋·refs 조회 | ✅ | `a036af5` |
| 15 | M4 레인 알고리즘 (e2e 213) | ✅ | `6a01d4d` |
| 16·17 | M4 History 탭 + 커밋 상세 + 컨텍스트 메뉴 프레임워크 | 대기 | |
| 18~21 | M5 Branches · Stash · 다이얼로그 규약 · 수동 검증 | 대기 | |
