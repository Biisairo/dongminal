...
통일**(`GO-39`·`FBE-08`·DoD 4번, §2.8)과 **`U-10`**(데이터 손실, §2.9)을 닫았다.

남은 것은 **DoD 5항목 · P2 · 사용자 보고 15건**(§3.4), 그리고 기존 흔들림이다.
...
| U-15 | **팝업의 기본 포커스를 그 팝업의 목적에 맞는 버튼에 두어 `Enter` 로 바로 실행**한다. 예: 삭제 확인창이면 삭제 버튼. `Esc` 는 동작하지 않고 창닫기. **모든 팝업에 통일** | **방향 확정 — 원안대로**(사용자 2026-09-10). 요구사항 개정을 동반한다: `FR-GIT-94`·`97`·`176` · `FR-COS-6` · e2e `V38`·`TC-COS-7` (아래) |
