...
func TestRender_OmitUUIDShort(t *testing.T) {
	l := Line{Label: "W1.P1.T1", ToolID: "12", ShellPID: 1, SizeCols: 80, SizeRows: 24, Session: "x", Tab: "y"}
	got := l.Render()
	want := "  label=W1.P1.T1  paneId=12  shellPid=1  size=80x24  session=\"x\"  tab=\"y\""
	if got != want {
		t.Fatalf("got=%q\nwant=%q", got, want)
	}
}
...
func TestRender_OmitSessionRegionUUID(t *testing.T) {
	l := Line{Label: "W1.P1.T1", UUID: "u", Short: "s", ToolID: "1", ShellPID: 2, SizeCols: 1, SizeRows: 2, Session: "a", Tab: "b"}
	got := l.Render()
	want := "  label=W1.P1.T1  uuid=u  short=s  paneId=1  shellPid=2  size=1x2  session=\"a\"  tab=\"b\""
	if got != want {
		t.Fatalf("got=%q\nwant=%q", got, want)
	}
}
...
func TestRender_OmitZeroSize(t *testing.T) {
	l := Line{Label: "L", ToolID: "1", ShellPID: 1, Session: "a", Tab: "b"}
	got := l.Render()
...
func TestRender_UnfocusedMarker(t *testing.T) {
	l := Line{FocusMarker: false, Label: "L", ToolID: "1", ShellPID: 1, Session: "a", Tab: "b"}
...
func TestRender_QuoteEscape(t *testing.T) {
	l := Line{Label: "L", ToolID: "1", ShellPID: 1, Session: `a"b`, Tab: "c"}
	got := l.Render()
...
func TestRender_Deterministic(t *testing.T) {
	l := Line{Label: "L", UUID: "u", Short: "s", ToolID: "1", ShellPID: 2, SizeCols: 80, SizeRows: 24, Session: "x", Tab: "y", WindowUUID: "su", PaneUUID: "ru"}
