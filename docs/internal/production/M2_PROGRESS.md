...
신설과 `hasHostname` 제거)을 닫았다.
남은 것은 **DoD 5항목 · P2 · 사용자 보고 7건**, 그리고 기존 흔들림이다.

**첫 일은 U-9 다** — hunk 툴바를 hover 에서 커서로 옮긴다. 사라지는 조건이 사용자
결정으로 확정돼 있고 배선이 절반 있다.
...
- docs/internal/production/M2_PROGRESS.md   ← 무엇이 끝났고 무엇이 남았는지
  · §2.8 git 실행 층 통일 · §2.9 U-10 · §2.10 탐색기 묶음 · §2.11 U-15 ·
    §2.12 U-7·U-8 · §2.13 U-18
  · §3.4 사용자 보고(근거·함정·충돌) — 닫힌 열은 ✅ 로 표시돼 있다.
    **U-9 상세를 그대로 딛는다 — 사라지는 조건은 사용자가 이미 정했다**
...
**1) U-9 — hunk 툴바를 hover 에서 커서로 (스펙 개정 동반) ← 여기서 시작**
...
**2) 남은 결함 U-1·U-3·U-17·U-19, 그리고 DoD 5항목·P2**
