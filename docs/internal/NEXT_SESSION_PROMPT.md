...
**현재: M1 구현 중.** 기준선 — Go 전체 통과 · gofmt clean · Playwright **187 → 196**.

| 단계 | 내용 | 상태 | 커밋 |
|:--:|---|---|---|
| — | 21단계 설계 계약 (`./design/GIT_M*_STEP*_CONTRACT.md`) | ✅ | `67bc325` |
| — | SRS §7 열린 결정 → 확정 (O1~O14) + §7.1 해석 (I1~I6) | ✅ | (SRS 커밋) |
| 1 | 묶음 A `internal/git` | ✅ | `f455137` |
| 2 | 묶음 B·C 서버 (`/repos`·`/pin`·`/unpin`·`/status`·`/signature`) | 진행 | |
| 3 | 묶음 D Git 창 골격 | ✅ e2e 196 | `8ed0396` |
| 4 | 묶음 B 클라 (좌측 GIT 섹션) | 진행 | |
| 5·6 | 묶음 E Changes 읽기 + 묶음 C 클라 폴링 | 대기 | |
| 7 | 묶음 F diff-content + Monaco DiffEditor | 대기 | |
| 8 | 묶음 G 상태바 chip | 대기 | |
| 9~11 | M2 (J 안전 정책 → H 스테이징 → I 커밋) | 대기 | |
| 12~13 | M3 원격 | 대기 | |
| 14~17 | M4 히스토리 | 대기 | |
| 18~21 | M5 참조 | 대기 | |
