...
**M1 완료.** M2·M3·M4 진행 중. 기준선 — `go test ./... -race` 전부 통과 ·
gofmt clean · Playwright **187 → 255**.
...
| 10·11 | 묶음 H 스테이징 · I 커밋 — 서버 완료, **클라 진행** | 진행 | `54d869c` |
| **M3** | | | |
| 12·13 | job 인프라 + fetch/pull/push — **서버측 완료**, 클라 남음 | 부분 | `ef45143` |
| **M4** | | | |
| 14 | 로그·커밋 상세·refs 조회 | ✅ | `a036af5` |
| 15 | 레인 알고리즘 (UI 보다 먼저 고정) | ✅ | `6a01d4d` |
| 16·17 | History 탭 + 커밋 상세 + 컨텍스트 메뉴 프레임워크 | 대기 | |
| **M5** | | | |
| 18·19 | Branches · Stash — **서버측 진행** | 진행 | |
