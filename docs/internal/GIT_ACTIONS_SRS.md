...
- **FR-GIT-280** 커밋 **mute**(비-조상·머지 커밋을 흐리게) · **reflog 언급 커밋 포함**
  토글. 둘 다 목록 질의의 인자이고 화면 상태다.
...
| **V207** | GIT-280·281·282 | e2e | mute·reflog 토글 · Console level/검색/replay · author override · 리포 드롭다운 각각 동작한다. replay 의 쓰기는 2단계 확인이다 |
...
| G 부분 스테이징 | 278·279 | ✅ |
| H 읽기 보강 | **281 Console** | ✅ |
| H 읽기 보강 | 276 Blame · 280 mute·reflog · 282 author override·리포 드롭다운 | ⬜ |
| I 최상위 난이도 | 283 merge editor · 284 인터랙티브 rebase · 285 clone/init | ⬜ |
