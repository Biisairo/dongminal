...
func UndoLast(s *core.Service, ctx context.Context, repo string) (core.Output, error) {
	return s.ExecWrite(ctx, repo, core.WriteSpec{Argv: []string{"reset", "--soft", undoRev}})
}
